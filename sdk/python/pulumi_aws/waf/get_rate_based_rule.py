...
def get_rate_based_rule(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('aws:waf/getRateBasedRule:getRateBasedRule', __args__, opts=opts, typ=_GetRateBasedRuleResult).value
