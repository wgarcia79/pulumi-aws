...
class ClusterClientAuthenticationTls(dict):
    def __init__(__self__, *,
        ...
        """
        :param List[str] certificate_authority_arns: List of ACM Certificate Authority Amazon Resource Names (ARNs).
        """
...
class ClusterEncryptionInfoEncryptionInTransit(dict):
    def __init__(__self__, *,
        ...
        """
        :param str client_broker: Encryption setting for data in transit between clients and brokers. Valid values: `TLS`, `TLS_PLAINTEXT`, and `PLAINTEXT`. Default value is `TLS_PLAINTEXT` when `encryption_in_transit` block defined, but `TLS` when `encryption_in_transit` block omitted.
