...
class EventSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `customer_aws_id` - The AWS customer account associated with the Neptune event notification subscription.
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] event_categories: A list of event categories for a `source_type` that you want to subscribe to. Run `aws neptune describe-event-categories` to find all the event categories.
