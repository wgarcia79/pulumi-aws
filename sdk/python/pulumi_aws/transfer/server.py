...
class Server(pulumi.CustomResource):
    ...
    endpoint_details: pulumi.Output[Optional['outputs.ServerEndpointDetails']] = pulumi.property("endpointDetails")
    """
    The virtual private cloud (VPC) endpoint settings that you want to configure for your SFTP server. Fields documented below.
    """

    endpoint_type: pulumi.Output[Optional[str]] = pulumi.property("endpointType")
    """
    ...
    host_key: pulumi.Output[Optional[str]] = pulumi.property("hostKey")
    """
    RSA private key (e.g. as generated by the `ssh-keygen -N "" -f my-new-server-key` command).
    """

    host_key_fingerprint: pulumi.Output[str] = pulumi.property("hostKeyFingerprint")
    """
    This value contains the message-digest algorithm (MD5) hash of the server's host key. This value is equivalent to the output of the `ssh-keygen -l -E md5 -f my-new-server-key` command.
    """

    identity_provider_type: pulumi.Output[Optional[str]] = pulumi.property("identityProviderType")
    """
    The mode of authentication enabled for this service. The default value is `SERVICE_MANAGED`, which allows you to store and access SFTP user credentials within the service. `API_GATEWAY` indicates that user authentication requires a call to an API Gateway endpoint URL provided by you to integrate an identity provider of your choice.
    """

    invocation_role: pulumi.Output[Optional[str]] = pulumi.property("invocationRole")
    """
    Amazon Resource Name (ARN) of the IAM role used to authenticate the user account with an `identity_provider_type` of `API_GATEWAY`.
    """

    logging_role: pulumi.Output[Optional[str]] = pulumi.property("loggingRole")
    """
    ...
    url: pulumi.Output[Optional[str]] = pulumi.property("url")
    """
