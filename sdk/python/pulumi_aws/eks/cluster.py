...
class Cluster(pulumi.CustomResource):
    ...
    certificate_authority: pulumi.Output['outputs.ClusterCertificateAuthority'] = pulumi.property("certificateAuthority")
    """
    ...
    enabled_cluster_log_types: pulumi.Output[Optional[List[str]]] = pulumi.property("enabledClusterLogTypes")
    """
    A list of the desired control plane logging to enable. For more information, see [Amazon EKS Control Plane Logging](https://docs.aws.amazon.com/eks/latest/userguide/control-plane-logs.html)
    """

    encryption_config: pulumi.Output[Optional['outputs.ClusterEncryptionConfig']] = pulumi.property("encryptionConfig")
    """
    ...
    identities: pulumi.Output[List['outputs.ClusterIdentity']] = pulumi.property("identities")
    """
    ...
    vpc_config: pulumi.Output['outputs.ClusterVpcConfig'] = pulumi.property("vpcConfig")
    """
