...
class Stream(pulumi.CustomResource):
    ...
    encryption_type: pulumi.Output[Optional[str]] = pulumi.property("encryptionType")
    """
    The encryption type to use. The only acceptable values are `NONE` or `KMS`. The default value is `NONE`.
    """

    enforce_consumer_deletion: pulumi.Output[Optional[bool]] = pulumi.property("enforceConsumerDeletion")
    """
    ...
    retention_period: pulumi.Output[Optional[float]] = pulumi.property("retentionPeriod")
    """
    ...
    shard_count: pulumi.Output[float] = pulumi.property("shardCount")
    """
    The number of shards that the stream will use.
    Amazon has guidelines for specifying the Stream size that should be referenced when creating a Kinesis stream. See [Amazon Kinesis Streams](https://docs.aws.amazon.com/kinesis/latest/dev/amazon-kinesis-streams.html) for more.
    """

    shard_level_metrics: pulumi.Output[Optional[List[str]]] = pulumi.property("shardLevelMetrics")
    """
