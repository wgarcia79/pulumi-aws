...
class Schedule(pulumi.CustomResource):
    ...
    end_time: pulumi.Output[str] = pulumi.property("endTime")
    """
    ...
    recurrence: pulumi.Output[str] = pulumi.property("recurrence")
    """
    The time when recurring future actions will start. Start time is specified by the user following the Unix cron syntax format.
    """

    scheduled_action_name: pulumi.Output[str] = pulumi.property("scheduledActionName")
    """
    The name of this scaling action.
    """

    start_time: pulumi.Output[str] = pulumi.property("startTime")
    """
