...
class MemcachedLayer(pulumi.CustomResource):
    allocated_memory: pulumi.Output[Optional[float]] = pulumi.property("allocatedMemory")
    """
    ...
    ebs_volumes: pulumi.Output[Optional[List['outputs.MemcachedLayerEbsVolume']]] = pulumi.property("ebsVolumes")
    """
