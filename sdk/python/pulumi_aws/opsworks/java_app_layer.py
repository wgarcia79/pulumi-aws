...
class JavaAppLayer(pulumi.CustomResource):
    ...
    app_server_version: pulumi.Output[Optional[str]] = pulumi.property("appServerVersion")
    """
    ...
    ebs_volumes: pulumi.Output[Optional[List['outputs.JavaAppLayerEbsVolume']]] = pulumi.property("ebsVolumes")
    """
    ...
    jvm_options: pulumi.Output[Optional[str]] = pulumi.property("jvmOptions")
    """
    Options to set for the JVM.
    """

    jvm_type: pulumi.Output[Optional[str]] = pulumi.property("jvmType")
    """
    Keyword for the type of JVM to use. Defaults to `openjdk`.
    """

    jvm_version: pulumi.Output[Optional[str]] = pulumi.property("jvmVersion")
    """
