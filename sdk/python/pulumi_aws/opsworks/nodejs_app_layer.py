...
class NodejsAppLayer(pulumi.CustomResource):
    ...
    ebs_volumes: pulumi.Output[Optional[List['outputs.NodejsAppLayerEbsVolume']]] = pulumi.property("ebsVolumes")
    """
    ...
    nodejs_version: pulumi.Output[Optional[str]] = pulumi.property("nodejsVersion")
    """
