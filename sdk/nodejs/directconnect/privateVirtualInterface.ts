...
export class PrivateVirtualInterface extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<PrivateVirtualInterfaceResult> {
...
/**
 * The live PrivateVirtualInterface resource.
 */
export interface PrivateVirtualInterfaceResult {
    /**
     * The address family for the BGP peer. `ipv4 ` or `ipv6`.
     */
