...
export class PublicVirtualInterface extends pulumi.CustomResource {
    ...
    public static addAdmissionPolicy(policy: pulumi.policy.AdmissionPolicy): void {
        pulumi.runtime.addAdmissionPolicy({
            ...policy,
            pulumiType: 'aws:directconnect/publicVirtualInterface:PublicVirtualInterface',
        });
    }
    /**
...
/**
 * The live PublicVirtualInterface resource.
 */
export interface PublicVirtualInterfaceResult {
    /**
     * The address family for the BGP peer. `ipv4 ` or `ipv6`.
     */
