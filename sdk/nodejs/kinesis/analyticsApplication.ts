...
export class AnalyticsApplication extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<AnalyticsApplicationResult> {
...
/**
 * The live AnalyticsApplication resource.
 */
export interface AnalyticsApplicationResult {
    /**
     * The ARN of the Kinesis Analytics Appliation.
     */
    readonly arn: ARN;
