...
export class ListenerCertificate extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<ListenerCertificateResult> {
        return ctx.list({...args, type: 'aws:elasticloadbalancingv2/listenerCertificate:ListenerCertificate'});
    }

    public static addAdmissionPolicy(policy: pulumi.policy.AdmissionPolicy): void {
        pulumi.runtime.addAdmissionPolicy({
            ...policy,
            pulumiType: 'aws:elasticloadbalancingv2/listenerCertificate:ListenerCertificate',
        });
    }
    /**
