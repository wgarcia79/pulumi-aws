...
export class ApnsVoipSandboxChannel extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<ApnsVoipSandboxChannelResult> {
...
/**
 * The live ApnsVoipSandboxChannel resource.
 */
export interface ApnsVoipSandboxChannelResult {
    /**
     * The application ID.
     */
