...
export class ServiceLinkedRole extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<ServiceLinkedRoleResult> {
...
/**
 * The live ServiceLinkedRole resource.
 */
export interface ServiceLinkedRoleResult {
    /**
     * The Amazon Resource Name (ARN) specifying the role.
     */
    readonly arn: string;
