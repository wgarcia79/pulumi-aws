...
export class OpenIdConnectProvider extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<OpenIdConnectProviderResult> {
...
/**
 * The live OpenIdConnectProvider resource.
 */
export interface OpenIdConnectProviderResult {
    /**
     * The ARN assigned by AWS for this provider.
     */
    readonly arn: string;
