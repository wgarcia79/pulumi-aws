...
export class ReplicationInstance extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<ReplicationInstanceResult> {
...
/**
 * The live ReplicationInstance resource.
 */
export interface ReplicationInstanceResult {
    /**
     * The amount of storage (in gigabytes) to be initially allocated for the replication instance.
     */
