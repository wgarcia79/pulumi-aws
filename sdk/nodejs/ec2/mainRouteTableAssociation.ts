...
export class MainRouteTableAssociation extends pulumi.CustomResource {
    ...
    public static addAdmissionPolicy(policy: pulumi.policy.AdmissionPolicy): void {
        pulumi.runtime.addAdmissionPolicy({
            ...policy,
            pulumiType: 'aws:ec2/mainRouteTableAssociation:MainRouteTableAssociation',
        });
    }
    /**
...
/**
 * The live MainRouteTableAssociation resource.
 */
export interface MainRouteTableAssociationResult {
    /**
     * Used internally, see __Notes__ below
     */
