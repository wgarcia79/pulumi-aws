...
export class VpcEndpoint extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<VpcEndpointResult> {
        return ctx.list({...args, type: 'aws:ec2/vpcEndpoint:VpcEndpoint'});
    }

    public static addAdmissionPolicy(policy: pulumi.policy.AdmissionPolicy): void {
        pulumi.runtime.addAdmissionPolicy({
            ...policy,
            pulumiType: 'aws:ec2/vpcEndpoint:VpcEndpoint',
        });
    }
    /**
