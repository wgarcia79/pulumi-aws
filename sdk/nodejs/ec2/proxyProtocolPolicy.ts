...
export class ProxyProtocolPolicy extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<ProxyProtocolPolicyResult> {
        return ctx.list({...args, type: 'aws:ec2/proxyProtocolPolicy:ProxyProtocolPolicy'});
    }

    public static addAdmissionPolicy(policy: pulumi.policy.AdmissionPolicy): void {
        pulumi.runtime.addAdmissionPolicy({
            ...policy,
            pulumiType: 'aws:ec2/proxyProtocolPolicy:ProxyProtocolPolicy',
        });
    }
    /**
