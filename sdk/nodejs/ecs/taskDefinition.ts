...
export class TaskDefinition extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<TaskDefinitionResult> {
        return ctx.list({...args, type: 'aws:ecs/taskDefinition:TaskDefinition'});
    }

    public static addAdmissionPolicy(policy: pulumi.policy.AdmissionPolicy): void {
        pulumi.runtime.addAdmissionPolicy({
            ...policy,
            pulumiType: 'aws:ecs/taskDefinition:TaskDefinition',
        });
    }
    /**
...
/**
 * The live TaskDefinition resource.
 */
export interface TaskDefinitionResult {
     ...
     * A set of volume blocks that containers in your task may use.
     */
    readonly volumes?: { dockerVolumeConfiguration?: { autoprovision?: boolean, driver?: string, driverOpts?: {[key: string]: string}, labels?: {[key: string]: string}, scope: string }, hostPath?: string, name: string }[];
}
