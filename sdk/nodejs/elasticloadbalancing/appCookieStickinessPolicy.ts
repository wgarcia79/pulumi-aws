...
export class AppCookieStickinessPolicy extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<AppCookieStickinessPolicyResult> {
...
/**
 * The live AppCookieStickinessPolicy resource.
 */
export interface AppCookieStickinessPolicyResult {
    /**
     * The application cookie whose lifetime the ELB's cookie should follow.
     */
