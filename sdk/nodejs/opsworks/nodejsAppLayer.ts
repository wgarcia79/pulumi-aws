...
export class NodejsAppLayer extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<NodejsAppLayerResult> {
...
/**
 * The live NodejsAppLayer resource.
 */
export interface NodejsAppLayerResult {
    /**
     * Whether to automatically assign an elastic IP address to the layer's instances.
     */
