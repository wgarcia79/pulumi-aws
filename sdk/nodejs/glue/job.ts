 ...
 *     command: {
 *         scriptLocation: pulmi.interpolate`s3://${aws_s3_bucket_example.bucket}/example.py`,
 *     },
 ...
 * const example = new aws.glue.Job("example", {
 *     command: {
 *         scriptLocation: pulmi.interpolate`s3://${aws_s3_bucket_example.bucket}/example.scala`,
 *     },
 *     defaultArguments: {
 *         "--job-language": "scala",
 *     },
