...
// 			return err
// 		}
// 		aWSCodeDeployRole, err := iam.NewRolePolicyAttachment(ctx, "aWSCodeDeployRole", &iam.RolePolicyAttachmentArgs{
...
// 					Ec2TagFilter: []map[string]interface{}{
...
// 					TriggerTargetArn: pulumi.String(exampleTopic.Arn),
// 				},
// 			},
// 		})
// 		if err != nil {
