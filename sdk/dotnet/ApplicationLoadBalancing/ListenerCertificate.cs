...
namespace Pulumi.Aws.ApplicationLoadBalancing
{
    ...
    public partial class ListenerCertificate : Pulumi.CustomResource
    {
        ...
        public ListenerCertificate(string name, ListenerCertificateArgs args, CustomResourceOptions? options = null)
            : base("aws:applicationloadbalancing/listenerCertificate:ListenerCertificate", name, args ?? new ListenerCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ListenerCertificate(string name, Input<string> id, ListenerCertificateState? state = null, CustomResourceOptions? options = null)
            : base("aws:applicationloadbalancing/listenerCertificate:ListenerCertificate", name, state, MakeResourceOptions(options, id))
        {
        }
