...
namespace Pulumi.Aws.Iam.Inputs
{
    ...
    public sealed class PolicyStatementArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("NotPrincipal")]
        public InputUnion<string, InputUnion<Inputs.AWSPrincipalArgs, InputUnion<Inputs.ServicePrincipalArgs, Inputs.FederatedPrincipalArgs>>>? NotPrincipal { get; set; }
        ...
        /// </summary>
        [Input("Principal")]
        public InputUnion<string, InputUnion<Inputs.AWSPrincipalArgs, InputUnion<Inputs.ServicePrincipalArgs, Inputs.FederatedPrincipalArgs>>>? Principal { get; set; }
